...
class ModelTrainer:
    ...
    def get_best_model(self, X, y):
        ...
        try:
            model_report = self.evaluate_models(X=X, y=y, models=self.models)
    ...
    def fine_tune_best_model(self, best_model_object:object, best_model_name, X_train, y_train)-> object:
        try:
            ...
            fine_tune_model = best_model_object.set_params(**best_params)
    ...
    def initiate_model_trainer(self, train_array, test_array):
        ...
        try:
            ...
            if best_model_score < 0.5:
                raise Exception('No best model found with an accuracy greater than the threshhold 0.6')
